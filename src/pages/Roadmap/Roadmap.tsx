...
const ExperienceSection: React.FC<Competency & { index: number }> = ({ title, description, index }) => {
    const aosAnimation = index % 2 === 0 ? "fade-right" : "fade-left";
    return (
        <div className="experience-item">
            <div className="timeline-dot"></div>
            <h6 className="section-number" data-aos={aosAnimation} data-aos-delay="50">
                Step {index + 1}
            </h6>
            <h3 className="title" data-aos={aosAnimation} data-aos-delay="100">
                {title}
            </h3>
            <div className="details" data-aos={aosAnimation} data-aos-delay="200">
                <p>{description}</p>
            </div>
        </div>
    );
...
const Experience: React.FC = () => {
    return (
        <div className="experience-container">
            ...
            <div className="custom-shape-divider-top-1741825181">
            ...
            <div className="custom-shape-divider-bottom-1741824976">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                     preserveAspectRatio="none">
                    <path
                        d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z"
